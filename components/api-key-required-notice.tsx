...
interface ApiKeyRequiredNoticeProps {
  className?: string;
}

export function ApiKeyRequiredNotice({ className }: ApiKeyRequiredNoticeProps) {
  return (
    <Alert className={`border-amber-500/50 bg-amber-500/10 ${className || ""}`}>
      ...
      <AlertDescription className="text-amber-500/90">
        ...
        <Link
          ...
          className="underline hover:text-amber-400 font-medium"
        >
          Go to Settings
        </Link>{" "}
        to add your key.
